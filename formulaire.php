...
<form action="" method="POST">
    <table>
        ...
        <tr>
            <th colspan="2">Expérience</th>
        </tr>
        <tr>
            <td><label for="nom_entreprise">Nom de l'entreprise :</label></td>
        ...
        <tr>
            <td><label for="skill1">Compétence 1 :</label></td>
            <td><input type="text" id="skill1" name="skill1" required></td>
        </tr>
        <tr>
            <td><label for="skill2">Compétence 2 :</label></td>
            <td><input type="text" id="skill2" name="skill2" required></td>
        </tr>
        <tr>
            <td><label for="skill3">Compétence 3 :</label></td>
            <td><input type="text" id="skill3" name="skill3" required></td>
        </tr>
    </table>
    <div>
        <button type="submit" class="btn">Enregistrer</button>
        <button type="button" class="btn" onclick="window.location.href='temp3.php'">Recevoir CV</button>
    </div>
</form>
